...
const teamMembers = [
    ...
    },
    {
        ...
        bio: "Over the past 20 years, I’ve worked across branding, design, marketing, and production, leading creative teams and building systems that connect strategy, communication, and measurable business growth.\n\nAfter graduating in graphic design, I went on to lead packaging production and design teams before founding my own branding and marketing agency, which I’ve successfully led for more than a decade.\n\nThroughout that time, I’ve managed multidisciplinary teams of 10+ people and worked on projects spanning branding, packaging, websites, content systems, marketing funnels, and conversion-focused digital experiences across tourism, hospitality, education, retail, and service industries.\n\nMy work combines creative direction, user psychology, brand positioning, and revenue-focused strategy — with a particular focus on helping businesses turn fragmented digital presence into clear, scalable systems that support long-term growth.\n\n Today, I primarily work with companies looking to strengthen direct customer relationships, improve conversion performance, and build digital ecosystems that generate measurable commercial results.",
    },
];
